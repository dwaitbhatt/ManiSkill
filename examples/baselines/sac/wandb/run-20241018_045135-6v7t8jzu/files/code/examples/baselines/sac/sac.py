...
if __name__ == "__main__":
    ...
    # env setup
    env_kwargs = dict(obs_mode="state", control_mode=args.control_mode, render_mode="human", sim_backend="gpu", robot_uids=args.robot)
    ...
    if args.capture_video:
        ...
        eval_envs = RecordEpisode(eval_envs, output_dir=eval_output_dir, save_trajectory=args.evaluate, trajectory_name="trajectory", max_steps_per_video=args.num_eval_steps, video_fps=30, wandb_run=wandb_run)
