...
if __name__ == "__main__":
    ...
    if args.capture_video:
        ...
        if args.save_train_video_freq is not None:
            ...
            envs = RecordEpisode(envs, output_dir=f"runs/{run_name}/train_videos", save_trajectory=False, save_video_trigger=save_video_trigger, max_steps_per_video=args.num_steps, video_fps=30, wandb_run=wandb_run)
