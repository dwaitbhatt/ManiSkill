...
def setup_envs(args: Args):
    ...
    if args.capture_video or args.save_trajectory:
        ...
        target_envs = RecordEpisode(target_envs, output_dir=eval_output_dir, save_trajectory=args.save_trajectory, save_video=args.capture_video, trajectory_name="trajectory", max_steps_per_video=args.num_eval_steps, video_fps=30, wandb_video_freq=args.wandb_video_freq)
...
if __name__ == "__main__":
    ...
    pbar = tqdm(range(args.total_timesteps), desc="Aligning agents")
