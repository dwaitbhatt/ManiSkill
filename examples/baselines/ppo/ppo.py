...
if __name__ == "__main__":
    ...
    # env setup
    env_kwargs = dict(robot_uids=args.robot_uids, obs_mode="state", render_mode="rgb_array", sim_backend="physx_cuda")
    ...
    if args.capture_video:
        ...
        eval_envs = RecordEpisode(eval_envs, output_dir=eval_output_dir, save_trajectory=args.evaluate, trajectory_name="trajectory", max_steps_per_video=args.num_eval_steps, video_fps=30, wandb_video_freq=args.wandb_video_freq)
