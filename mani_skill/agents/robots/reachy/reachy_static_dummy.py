...
@register_agent()
class Reachy2StaticDummy(BaseAgent):
    uid = "reachy2_static_dummy"
    urdf_path = f"{PACKAGE_ASSET_DIR}/robots/reachy/reachy2_dummy.urdf"
    urdf_config = dict(
        _materials=dict(
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.r_hand_joint_names = [
            "r_hand_finger",
            "r_hand_finger_mimic"
        ]        
        self.l_hand_joint_names = [
            "l_hand_finger",
            "l_hand_finger_mimic"
        ]
        ...
        self.camera_link_name = "camera_optical_left"
    ...
    def _controller_configs(self):
        ...
        l_gripper_pd_joint_pos = PDJointPosMimicControllerConfig(
            self.l_hand_joint_names,
        ...
        r_gripper_pd_joint_pos = PDJointPosMimicControllerConfig(
            self.r_hand_joint_names,
            -0.01,  # a trick to have force when the object is thin
            0.05,
            self.gripper_stiffness,
        ...
        controller_configs = dict(
            pd_joint_delta_pos=dict(
                ...
                l_gripper=l_gripper_pd_joint_pos,
                r_gripper=r_gripper_pd_joint_pos,
    ...
    def _after_init(self):
        ...
        self.camera_link: Link = sapien_utils.get_obj_by_name(
