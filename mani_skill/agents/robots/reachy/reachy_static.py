...
@register_agent()
class ReachyStatic(BaseAgent):
    uid = "reachy_static"
    urdf_path = f"{PACKAGE_ASSET_DIR}/robots/reachy/reachy_static_old.urdf"
    urdf_config = dict(
        _materials=dict(
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.arm_damping = 1e6
        self.arm_force_limit = 1e6

        self.gripper_stiffness = 1e5
        self.gripper_damping = 2000 # 0.1
    ...
    def _after_init(self):
        ...
        self.l_camera_link: Link = sapien_utils.get_obj_by_name(
            self.robot.get_links(), self.l_camera_link_name
        )
        self.r_camera_link: Link = sapien_utils.get_obj_by_name(
