...
scene.set_environment_map("/home/dwait/ManiSkill/mani_skill/agents/robots/xarm6/env.ktx")
scene.add_directional_light([0.2, 0.2, -1], [1, 1, 1], True, shadow_scale=3, shadow_near=-5, shadow_far=5)
scene.add_ground(-1, render=True)
...
# Articulation
urdf_file = "/home/dwait/ManiSkill/mani_skill/assets/robots/xarm6/xarm6_xarmgripper.urdf"
