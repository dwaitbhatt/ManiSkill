...
class RoboCasaKitchenEnv(BaseEnv):
    SUPPORTED_ROBOTS = ["fetch", "reachy2"]
    ...
    def _default_sensor_configs(self):
        ...
        base_camera = CameraConfig("base_camera", pose, 128, 128, 60 * np.pi / 180, 0.01, 100)
        
        closeup_pose = sapien_utils.look_at([3.31511, -4.52746, 1.60833], [2.1, -3.72, 0.96])
        closeup_camera = CameraConfig("closeup_camera", pose=closeup_pose, width=256, height=256, fov=1.2, near=0.1, far=1e+03)
